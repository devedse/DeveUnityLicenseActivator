...
$originalFile = "DeveUnityLicenseActivator.ConsoleApp\bin\Release\netcoreapp3.1\win-x64\publish\DeveUnityLicenseActivator.ConsoleApp.exe"

$fileToPackage = "DeveUnityLicenseActivator.ConsoleApp\bin\Release\netcoreapp3.1\win-x64\publish\DeveUnityLicenseActivator.exe"
